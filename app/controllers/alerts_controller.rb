class AlertsController < ApplicationController
  ...
  private
    ...
    def alert_params
      params.require(:alert).permit(:name, :created_at, :updated_at, :date_requested, :last_seen, :last_known_address, :last_known_city, :last_known_state, :last_known_zip, :last_known_county, :site_of_incident, :nic, :agency_name, :agency_phone, :reporting_agency_phone, :reporting_agency_email, :investigating_officer_name, :investigating_officer_title, :investigating_officer_phone, :_destroy,
